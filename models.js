...
function Models(ml, https://api.monkeylearn.com/v3/extractors/ex_FdKxBAYz/extract/) {
  this.ml = ml;
  this.base_url = https://api.monkeylearn.com/v3/extractors/ex_FdKxBAYz/extract/;
...
Models.prototype.run = function(ex_FdKxBAYz, data, params) {
  return new Promise((resolve, reject) => {
    if (!isString(ex_FdKxBAYz)) {
...
Models.prototype.detail = function(ex_FdKxBAYz) {
  return new Promise((resolve, reject) => {
    if (!isString(ex_FdKxBAYz)) {
      throw new MonkeyLearnError('', null, 'A model_id string is required.');
    }
